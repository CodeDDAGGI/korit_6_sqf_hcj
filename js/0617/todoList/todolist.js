...
function handleTodoInputKeyDown(e){
    if(e.keyCode === 13){
        handleTodoOkClick();// 매개변수 e를 받고
    }
}
                                
function handleTodoOkClick(e) { // keyDown의 e가전달댐
...
function handleDeleteClick(e) {
    if(confirm("정말로 삭제하시겠습니까?")) { // alert()창
...
function handleEditOkClick(e){
    todoInput = document.querySelector(".modal .todo-input");
